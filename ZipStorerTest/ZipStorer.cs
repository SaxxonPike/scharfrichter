...
namespace System.IO.Compression
{
    ...
    public class ZipStorer : IDisposable
    {
        ...
        /// <summary>
        /// Open a stream on a stored file. The returned stream must be disposed after.
        /// </summary>
        public Stream StreamFile(ZipFileEntry _zfe)
        {
            // check signature
            ...
            if (_zfe.Method == Compression.Store)
                ...
                inStream = new ZipDeflateStream(this.ZipFileStream, _zfe);
            else
                return null;
